		...
		<div>
			...
			<div className="mx-10 text-2xl mb-10 mt-10 main">
				...
				<p>
					...
					walks through our door, we also dedicate ourselves to our community!
					The Blue Iguana team makes it a goal to participate in, and host a
					minimum of 60 charity and fundraising events annually. It is our
					pleasure to give back to and build our community up to its highest
					potential, and care for those in need to the best of our ability. This
					is our home, and the people of this community are our family.
				...
				{data.map((x) => {
					return (
						...
						<div>
							...
							<h2 className='text-center text-xl font-extrabold'>{x.title}</h2>

...
export default function Home() {
	return (
		<div>
			...
			<div className='container home-container -mt-24 relative z-40 border-2  border-opacity-100 border-solid rounded-lg shadow-inner-2xl shadow-2xl  bg-white z-10 '>
				<h1 className='font-bold relative text-center text-3xl mt-10'>
				...
				<div className='container relative md:mx-auto'>
					<div className='mx-10 text-2xl mb-10 mt-10'>
						...
						<p>
							...
							strong focus to support local business.met lacus accumsan et
							viverra justo commodo. Proin sodales pulvinar sic tempor. Sociis
							natoque penatibus et magnis dis parturient montes, nascetur
							ridiculus mus. Nam fermentum, nulla luctus pharetra vulputate,
							felis tellus mollis orci, sed rhoncus pronin sapien nunc accuan
							eget.
						</p>
					</div>
